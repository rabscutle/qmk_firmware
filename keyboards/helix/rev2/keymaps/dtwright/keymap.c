...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LCTL, KC_LGUI, ADJUST, KC_LALT, KC_BSPC,    LOWER,   KC_SPC,  LT(_MOUSE, KC_SPC),  RAISE,   KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT,   KC_RCTL \
      ),
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, _______, _______, _______, KC_ENT, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY, _______ \
      ),
  ...
  [_MOUSE] =  LAYOUT( \
      ...
      _______, _______, _______, KC_WH_L, KC_WH_D, KC_WH_R, _______, _______, _______, _______, _______, _______, _______, _______, \
